...
/** \file
 *  \brief USB Device definitions for the EFM32 Giant Gecko microcontrollers.
 *  \copydetails Group_Device_EFM32GG
 *
 ...
 *  \defgroup Group_Device_EFM32GG Device Management (EFM32GG)
 *  \brief USB Device definitions for the EFM32 Giant Gecko microcontrollers.
 *
 *  Architecture specific USB Device definitions for the Silabs 32-bit EFM32 Giant Gecko microcontrollers.
 *
 *  @{
 */

#ifndef __USBDEVICE_EFM32GG_H__
#define __USBDEVICE_EFM32GG_H__
...
{
	return USB->HFNUM & _USB_HFNUM_RESETVALUE;
}
...
{
	/* Low speed PHY */
	USB->DCFG = (USB->DCFG & ~_USB_DCFG_DEVSPD_MASK) | 2;
}
...
{
	/* Full speed PHY */
	USB->DCFG = (USB->DCFG & ~_USB_DCFG_DEVSPD_MASK) | 3;
}
...
static inline void USB_Device_SetDeviceAddress(const uint8_t Address)
{
	USB->DCFG = (USB->DCFG & ~_USB_DCFG_DEVADDR_MASK) |
	            (Address << _USB_DCFG_DEVADDR_SHIFT);
}
...
{
	return (USB->DCFG & _USB_DCFG_DEVADDR_MASK) ? true : false;
}
