 ...
 *     for the Giant Gecko EFM32GG microcontrollers.
 *  \copydetails Group_EndpointStreamRW_EFM32GG
 *
 *  \note This file should not be included directly. It is automatically
 *   included as needed by the USB driver dispatch header located in LUFA/Drivers/USB/USB.h.
 */

/** \ingroup Group_EndpointStreamRW
 *  \defgroup Group_EndpointStreamRW_EFM32GG Read/Write of Multi-Byte Streams (EFM32GG)
 *  \brief Endpoint data stream transmission and reception management for the Silabs Giant Gecko EFM32GG architecture.
 *
...
#ifndef __ENDPOINT_STREAM_EFM32GG_H__
#define __ENDPOINT_STREAM_EFM32GG_H__
