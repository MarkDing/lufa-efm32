...
#define LEDS_LED1        1 // TODO: Add mask for first board LED here

/** LED mask for the second LED on the board. */
#define LEDS_LED2        2 // TODO: Add mask for second board LED here
...
{
	/* PE2 and PE3 are LEDs, set as push pull*/
