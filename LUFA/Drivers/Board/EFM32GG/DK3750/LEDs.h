...
// #define LEDS_LED9        (1 << 8)
// #define LEDS_LED10       (1 << 9)
// #define LEDS_LED11       (1 << 10)
// #define LEDS_LED12       (1 << 11)
// #define LEDS_LED13       (1 << 12)
// #define LEDS_LED14       (1 << 13)
// #define LEDS_LED15       (1 << 14)
// #define LEDS_LED16       (1 << 15)
...
{
	uint32_t tmp;
	tmp = BSP_RegisterRead(BSP_LED_PORT) & LEDS_ALL_LEDS;
	tmp |= LEDMask;
...
{
	return (BSP_RegisterRead(BSP_LED_PORT) & LEDS_ALL_LEDS);
}
#endif
